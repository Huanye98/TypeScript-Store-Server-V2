...
const removeProductFromCart = async (req, res, next) => {
    ...
    try {
        const response = await Users.removeProductFromUserCartDb(product_id, quantity, user_id);
...
const userGetsOrders = async (req, res, next) => {
    const { id } = req.params;
    try {
...
const userGetsOrderDetails = async (req, res, next) => {
    const { id } = req.params;
