...
exports.calculateOrderCost = exports.calculateShipping = exports.cancelPrintfulOrder = exports.updatePrintfulOrder = exports.getPrintfulOrderDetails = exports.getPrintfulOrders = exports.syncPrintfulProducts = exports.getPrintfulProductDetails = exports.getPrintfulProducts = void 0;
...
const getPrintfulProductDetails = async (productId) => {
    try {
...
exports.getPrintfulProductDetails = getPrintfulProductDetails;
const syncPrintfulProducts = async () => {
  ...
  `;
    ...
    try {
        ...
        const products = await (0, exports.getPrintfulProducts)();
        //fetch each product and insert into the database
        for (const { id } of products) {
            const result = await (0, exports.getPrintfulProductDetails)(id);
...
exports.syncPrintfulProducts = syncPrintfulProducts;
//Orders
const getPrintfulOrders = async (orderId) => {
    try {
...
exports.getPrintfulOrders = getPrintfulOrders;
const getPrintfulOrderDetails = async (orderId) => {
    try {
...
exports.getPrintfulOrderDetails = getPrintfulOrderDetails;
const updatePrintfulOrder = async (orderId, orderData) => {
    try {
...
exports.updatePrintfulOrder = updatePrintfulOrder;
const cancelPrintfulOrder = async (orderId) => {
    try {
...
exports.cancelPrintfulOrder = cancelPrintfulOrder;
...
const calculateOrderCost = async (orderData) => {
    try {
